...
describe("bankedDice rolling semantics", () => {
  it("when bankedDice > 0, the next roll must roll exactly that many dice (all at once)", () => {
    const pid = P("p0");
    ...
    expect(ok.nextState.bankedDice).toBe(1);
